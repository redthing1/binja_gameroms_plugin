...
class NDSView(BinaryView):
	...
	def init_arm9(self):
		try:
			...
			self.define_auto_symbol(Symbol(SymbolType.FunctionSymbol, self.arm9_entry_addr, "_start9"))
			return True
		except:
	...
	def init_arm7(self):
		try:
			...
			self.define_auto_symbol(Symbol(SymbolType.FunctionSymbol, self.arm7_entry_addr, "_start7"))
